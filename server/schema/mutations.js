...
const mutation = new GraphQLObjectType({
	...
	fields: {
		...
		updateNoncon:{
			...
			resolve(parentValue, { id, nc_status, nc_date_closed, nc_is_repeat, nc_root_cause }) {
				return new Promise((resolve,reject) => {
					Noncon.findOneAndUpdate(
						{"_id": id},
						{"$set": {nc_status: nc_status, nc_date_closed: nc_date_closed, id: id, nc_is_repeat: nc_is_repeat, nc_root_cause: nc_root_cause } },
						{"new": true}
					).exec((err, res) => {
