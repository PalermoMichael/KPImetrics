...
// Instructs Passport how to authenticate a user using a locally saved name
// and password combination.  This strategy is called whenever a user attempts to
// log in.  We first find the user model in MongoDB that matches the submitted name,
// then check to see if the provided password matches the saved password. There
// are two obvious failure points here: the name might not exist in our DB or
...
// with this name address to avoid making multiple accounts with identical addresses
